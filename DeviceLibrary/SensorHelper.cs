...
namespace DeviceLibrary
{
    ...
    private GpioPin ledPin2;
        ...
        public void ReadADC()
        {
            ...
            adcValue = ConvertPulseToDouble(readBuffer);
        ...
        public static double GetSensorPulseValue()
        {
            ...
            try
            {
                ...
                return ConvertPulseToDouble(readBuffer);
            }
            catch (Exception exc)
            {
                return 0.0;
        ...
        public static double ConvertPulseToDouble(byte[] data)
        {
            int result = 0;
